...
layui.define(['laytpl', 'laypage', 'layer', 'form', 'util'], function (exports) {
    ...
    var $ = layui.$
        ...
        , ELEM_VIEW = 'layui-table-view', ELEM_TOOL = '.layui-table-tool', ELEM_BOX = '.layui-table-box', ELEM_INIT = '.layui-table-init', ELEM_HEADER = '.layui-table-header', ELEM_BODY = '.layui-table-body', ELEM_MAIN = '.layui-table-main',
        ELEM_FIXED = '.layui-table-fixed', ELEM_FIXL = '.layui-table-fixed-l', ELEM_FIXR = '.layui-table-fixed-r', ELEM_TOTAL = '.layui-table-total', ELEM_PAGE = '.layui-table-page', ELEM_SORT = '.layui-table-sort', ELEM_EDIT = 'layui-table-edit',
    ...
    Class.prototype.pullData = function (curr) {
        ...
        if (options.url) { //Ajax请求
            ...
            //MODIFY BY WUWENBIN 2020年02月01日18:15:45
            if (typeof options.initSort === 'object') {
            ...
            //MODIFY BY WUWENBIN 2020年02月01日18:15:33
            var _headers = options.headers;
            var accessToken = _headers[NP_Config.request.tokenName];
            if (accessToken === undefined || accessToken === '' || accessToken === "undefined" || accessToken === null) {
                _headers[NP_Config.request.tokenName] = layui.data(NP_Config.tableName)[NP_Config.request.tokenName]
            }

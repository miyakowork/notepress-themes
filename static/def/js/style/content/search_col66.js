...
layui.define(['laytpl', 'laypage', 'timeago'], function (exports) {
    ...
    exports('search', function (obj) {
        ...
        tpl(col_66).render(obj, function (html) {
            ...
            initSearchPage(laypage, tpl, timeago, obj.nonePage);
    ...
    var col_66 =
        ...
        '<i class="fa fa-search"></i>&nbsp;有关【<span style="color: #F44336;">{{d.s}}</span>】的搜索结果 ~</blockquote> ' +
...
function initSearchPage(laypage, laytpl, timeago, page) {

...
layui.define(['laytpl', 'laypage', 'carousel', 'timeago', 'affixside'], function (exports) {
    ...
    exports('col39list', function (obj) {
        tpl(col_l3r9_list).render(obj, function (html) {
            $("#article-list-col39").append(html);
            initCol39ListPage(laypage, tpl, ch, timeago, obj.nonePage);
...
function initCol39ListPage(laypage, laytpl, tplHTML, timeago, page) {
